...
export type spaceMetaData = { space: string; owner: string; writers: string[]; isWriteable: boolean }
export type shareMetaData = { share: string; owner: string; name: string; path: string }
export type readdirResult = string | { name: string; path: string; stat: Stat; space?: spaceMetaData; share?: shareMetaData }
